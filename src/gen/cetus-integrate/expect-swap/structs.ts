...
export interface ExpectSwapResultFields {
  amountIn: ToField<'u256'>
  amountOut: ToField<'u256'>
  feeAmount: ToField<'u256'>
  feeRate: ToField<'u64'>
...
export class ExpectSwapResult implements StructClass {
  ...
  readonly feeAmount: ToField<'u256'>
  ...
  static get bcs(): ReturnType<typeof ExpectSwapResult.instantiateBcs> {
  ...
  static fromFields(fields: Record<string, any>): ExpectSwapResult {
    return ExpectSwapResult.reified().new({
      amountIn: decodeFromFields('u256', fields.amount_in),
      amountOut: decodeFromFields('u256', fields.amount_out),
      feeAmount: decodeFromFields('u256', fields.fee_amount),
  ...
  static fromFieldsWithTypes(item: FieldsWithTypes): ExpectSwapResult {
    if (!isExpectSwapResult(item.type)) {
      throw new Error('not a ExpectSwapResult type')
    }

    return ExpectSwapResult.reified().new({
      amountIn: decodeFromFieldsWithTypes('u256', item.fields.amount_in),
      amountOut: decodeFromFieldsWithTypes('u256', item.fields.amount_out),
      feeAmount: decodeFromFieldsWithTypes('u256', item.fields.fee_amount),
  ...
  static fromBcs(data: Uint8Array): ExpectSwapResult {
  ...
  static fromJSONField(field: any): ExpectSwapResult {
    return ExpectSwapResult.reified().new({
      amountIn: decodeFromJSONField('u256', field.amountIn),
      amountOut: decodeFromJSONField('u256', field.amountOut),
      feeAmount: decodeFromJSONField('u256', field.feeAmount),
...
export class SwapResult implements StructClass {
  ...
  readonly amountOut: ToField<'u256'>
  readonly feeAmount: ToField<'u256'>
  readonly refFeeAmount: ToField<'u256'>
  ...
  static fromFields(fields: Record<string, any>): SwapResult {
    return SwapResult.reified().new({
      ...
      amountOut: decodeFromFields('u256', fields.amount_out),
      feeAmount: decodeFromFields('u256', fields.fee_amount),
      refFeeAmount: decodeFromFields('u256', fields.ref_fee_amount),
  ...
  static fromFieldsWithTypes(item: FieldsWithTypes): SwapResult {
    ...
    return SwapResult.reified().new({
      ...
      amountOut: decodeFromFieldsWithTypes('u256', item.fields.amount_out),
      feeAmount: decodeFromFieldsWithTypes('u256', item.fields.fee_amount),
      refFeeAmount: decodeFromFieldsWithTypes('u256', item.fields.ref_fee_amount),
  ...
  static fromJSONField(field: any): SwapResult {
    return SwapResult.reified().new({
      ...
      amountOut: decodeFromJSONField('u256', field.amountOut),
      feeAmount: decodeFromJSONField('u256', field.feeAmount),
      refFeeAmount: decodeFromJSONField('u256', field.refFeeAmount),
...
export class ExpectSwapResultEvent implements StructClass {
  ...
  static get bcs(): ReturnType<typeof ExpectSwapResultEvent.instantiateBcs> {
  ...
  static fromFields(fields: Record<string, any>): ExpectSwapResultEvent {
    return ExpectSwapResultEvent.reified().new({
      data: decodeFromFields(ExpectSwapResult.reified(), fields.data),
      currentSqrtPrice: decodeFromFields('u128', fields.current_sqrt_price),
    })
  }

  static fromFieldsWithTypes(item: FieldsWithTypes): ExpectSwapResultEvent {
    if (!isExpectSwapResultEvent(item.type)) {
      throw new Error('not a ExpectSwapResultEvent type')
    }

    return ExpectSwapResultEvent.reified().new({
      data: decodeFromFieldsWithTypes(ExpectSwapResult.reified(), item.fields.data),
      currentSqrtPrice: decodeFromFieldsWithTypes('u128', item.fields.current_sqrt_price),
    })
  }

  static fromBcs(data: Uint8Array): ExpectSwapResultEvent {
  ...
  static fromJSONField(field: any): ExpectSwapResultEvent {
    return ExpectSwapResultEvent.reified().new({
      data: decodeFromJSONField(ExpectSwapResult.reified(), field.data),
      currentSqrtPrice: decodeFromJSONField('u128', field.currentSqrtPrice),
    })
  }

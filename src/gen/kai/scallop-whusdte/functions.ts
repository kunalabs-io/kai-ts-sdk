...
export function new_(tx: Transaction, args: NewArgs) {
  return tx.moveCall({
    target: `${PUBLISHED_AT}::scallop_whusdte::new`,
...
export function withdraw(tx: Transaction, args: WithdrawArgs) {
  return tx.moveCall({
    target: `${PUBLISHED_AT}::scallop_whusdte::withdraw`,
    arguments: [
...
export function assertVersion(tx: Transaction, strategy: TransactionObjectInput) {
  return tx.moveCall({
    target: `${PUBLISHED_AT}::scallop_whusdte::assert_version`,
...
export function migrate(tx: Transaction, args: MigrateArgs) {
  return tx.moveCall({
    target: `${PUBLISHED_AT}::scallop_whusdte::migrate`,
...
export function assertAdmin(tx: Transaction, args: AssertAdminArgs) {
  return tx.moveCall({
    target: `${PUBLISHED_AT}::scallop_whusdte::assert_admin`,
    arguments: [obj(tx, args.cap), obj(tx, args.strategy)],
  })
}
...
export function joinVault(tx: Transaction, args: JoinVaultArgs) {
  return tx.moveCall({
    target: `${PUBLISHED_AT}::scallop_whusdte::join_vault`,
    arguments: [
...
export function rebalance(tx: Transaction, args: RebalanceArgs) {
  return tx.moveCall({
    target: `${PUBLISHED_AT}::scallop_whusdte::rebalance`,
    arguments: [
      obj(tx, args.cap),
      obj(tx, args.strategy),
      obj(tx, args.vault),
...
export function removeFromVault(tx: Transaction, args: RemoveFromVaultArgs) {
  return tx.moveCall({
    target: `${PUBLISHED_AT}::scallop_whusdte::remove_from_vault`,
    arguments: [
      obj(tx, args.cap),
      obj(tx, args.strategy),
      obj(tx, args.scallopVersion),
...
export function assertScallopMarket(tx: Transaction, market: TransactionObjectInput) {
  return tx.moveCall({
    target: `${PUBLISHED_AT}::scallop_whusdte::assert_scallop_market`,
...
export function assertScallopPool(tx: Transaction, pool: TransactionObjectInput) {
  return tx.moveCall({
    target: `${PUBLISHED_AT}::scallop_whusdte::assert_scallop_pool`,
...
export function assertScallopRewardsPool(tx: Transaction, pool: TransactionObjectInput) {
  return tx.moveCall({
    target: `${PUBLISHED_AT}::scallop_whusdte::assert_scallop_rewards_pool`,
    arguments: [obj(tx, pool)],
  })
}
...
export function depositSoldProfits(tx: Transaction, args: DepositSoldProfitsArgs) {
  return tx.moveCall({
    target: `${PUBLISHED_AT}::scallop_whusdte::deposit_sold_profits`,
    arguments: [
      obj(tx, args.cap),
      obj(tx, args.strategy),
      obj(tx, args.vault),
...
export function takeProfitsForSelling(tx: Transaction, args: TakeProfitsForSellingArgs) {
  return tx.moveCall({
    target: `${PUBLISHED_AT}::scallop_whusdte::take_profits_for_selling`,
    arguments: [
      obj(tx, args.cap),
      obj(tx, args.strategy),

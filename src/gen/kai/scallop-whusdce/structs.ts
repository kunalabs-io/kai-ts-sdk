...
import { COIN } from '../../_dependencies/source/0x5d4b302506645c37ff133b98c4b50a5ae14841659738d6d733d59d0d217a93bf/coin/structs'
...
export function isAdminCap(type: string): boolean {
  ...
  return type === `${PKG_V1}::scallop_whusdce::AdminCap`
}
...
export class AdminCap implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::scallop_whusdce::AdminCap`
  static readonly $numTypeParams = 0
  static readonly $isPhantom = [] as const

  readonly $typeName = AdminCap.$typeName
  readonly $fullTypeName: `${typeof PKG_V1}::scallop_whusdce::AdminCap`
  readonly $typeArgs: []
  ...
  private constructor(typeArgs: [], fields: AdminCapFields) {
    this.$fullTypeName = composeSuiType(
      AdminCap.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::scallop_whusdce::AdminCap`
...
export function isStrategy(type: string): boolean {
  type = compressSuiType(type)
  return type === `${PKG_V1}::scallop_whusdce::Strategy`
}
...
export class Strategy implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::scallop_whusdce::Strategy`
  static readonly $numTypeParams = 0
  static readonly $isPhantom = [] as const

  readonly $typeName = Strategy.$typeName
  readonly $fullTypeName: `${typeof PKG_V1}::scallop_whusdce::Strategy`
  readonly $typeArgs: []
  ...
  private constructor(typeArgs: [], fields: StrategyFields) {
    this.$fullTypeName = composeSuiType(
      Strategy.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::scallop_whusdce::Strategy`
    this.$typeArgs = typeArgs

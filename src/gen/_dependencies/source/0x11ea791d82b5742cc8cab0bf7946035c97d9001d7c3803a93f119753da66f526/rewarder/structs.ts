...
export function isEmergentWithdrawEvent(type: string): boolean {
  type = compressSuiType(type)
  return type === `${PKG_V2}::rewarder::EmergentWithdrawEvent`
}
...
export class EmergentWithdrawEvent implements StructClass {
  ...
  static readonly $typeName = `${PKG_V2}::rewarder::EmergentWithdrawEvent`
  static readonly $numTypeParams = 0
  static readonly $isPhantom = [] as const

  readonly $typeName = EmergentWithdrawEvent.$typeName
  readonly $fullTypeName: `${typeof PKG_V2}::rewarder::EmergentWithdrawEvent`
  readonly $typeArgs: []
  ...
  private constructor(typeArgs: [], fields: EmergentWithdrawEventFields) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs
    ) as `${typeof PKG_V2}::rewarder::EmergentWithdrawEvent`
    this.$typeArgs = typeArgs

...
export function isOptionU128(type: string): boolean {
  ...
  return type === `${PKG_V3}::option_u128::OptionU128`
}
...
export class OptionU128 implements StructClass {
  ...
  static readonly $typeName = `${PKG_V3}::option_u128::OptionU128`
  static readonly $numTypeParams = 0
  static readonly $isPhantom = [] as const

  readonly $typeName = OptionU128.$typeName
  readonly $fullTypeName: `${typeof PKG_V3}::option_u128::OptionU128`
  readonly $typeArgs: []
  ...
  private constructor(typeArgs: [], fields: OptionU128Fields) {
    this.$fullTypeName = composeSuiType(
      OptionU128.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V3}::option_u128::OptionU128`
  ...
  static reified(): OptionU128Reified {
    return {
      ...
      fromBcs: (data: Uint8Array) => OptionU128.fromBcs(data),
      bcs: OptionU128.bcs,

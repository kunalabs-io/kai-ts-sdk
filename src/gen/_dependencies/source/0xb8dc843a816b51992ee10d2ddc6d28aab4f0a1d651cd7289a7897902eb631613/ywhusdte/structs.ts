...
export function isYWHUSDTE(type: string): boolean {
  ...
  return type === `${PKG_V1}::ywhusdte::YWHUSDTE`
}
...
export class YWHUSDTE implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::ywhusdte::YWHUSDTE`
  static readonly $numTypeParams = 0
  static readonly $isPhantom = [] as const

  readonly $typeName = YWHUSDTE.$typeName
  readonly $fullTypeName: `${typeof PKG_V1}::ywhusdte::YWHUSDTE`
  readonly $typeArgs: []
  ...
  private constructor(typeArgs: [], fields: YWHUSDTEFields) {
    this.$fullTypeName = composeSuiType(
      YWHUSDTE.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::ywhusdte::YWHUSDTE`

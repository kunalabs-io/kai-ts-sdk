...
export type MintAllowanceReified<T extends PhantomTypeArgument> = Reified<
  MintAllowance<T>,
  MintAllowanceFields<T>
>
...
export class MintAllowance<T extends PhantomTypeArgument> implements StructClass {
  ...
  readonly $fullTypeName: `${typeof PKG_V1}::mint_allowance::MintAllowance<${PhantomToTypeStr<T>}>`
  ...
  private constructor(typeArgs: [PhantomToTypeStr<T>], fields: MintAllowanceFields<T>) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs
    ) as `${typeof PKG_V1}::mint_allowance::MintAllowance<${PhantomToTypeStr<T>}>`
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        MintAllowance.$typeName,
        ...[extractType(T)]
      ) as `${typeof PKG_V1}::mint_allowance::MintAllowance<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`,
  ...
  static fromFields<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return MintAllowance.reified(typeArg).new({ value: decodeFromFields('u64', fields.value) })
  }
  ...
  static fromJSONField<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return MintAllowance.reified(typeArg).new({ value: decodeFromJSONField('u64', field.value) })
  }

...
export function isPoolFactoryAdminCap(type: string): boolean {
  ...
  return type === `${PKG_V1}::pool_factory::PoolFactoryAdminCap`
}
...
export class PoolFactoryAdminCap implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::pool_factory::PoolFactoryAdminCap`
  static readonly $numTypeParams = 0
  static readonly $isPhantom = [] as const

  readonly $typeName = PoolFactoryAdminCap.$typeName
  readonly $fullTypeName: `${typeof PKG_V1}::pool_factory::PoolFactoryAdminCap`
  readonly $typeArgs: []
  readonly $isPhantom = PoolFactoryAdminCap.$isPhantom
  ...
  private constructor(typeArgs: [], fields: PoolFactoryAdminCapFields) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs
    ) as `${typeof PKG_V1}::pool_factory::PoolFactoryAdminCap`
  ...
  static reified(): PoolFactoryAdminCapReified {
    return {
      ...
      typeArgs: [] as [],
      isPhantom: PoolFactoryAdminCap.$isPhantom,
      reifiedTypeArgs: [],
      ...
      fromSuiObjectData: (content: SuiObjectData) => PoolFactoryAdminCap.fromSuiObjectData(content),
  ...
  static fromSuiObjectData(data: SuiObjectData): PoolFactoryAdminCap {
    if (data.bcs) {
      if (data.bcs.dataType !== 'moveObject' || !isPoolFactoryAdminCap(data.bcs.type)) {
        throw new Error(`object at is not a PoolFactoryAdminCap object`)
      }

      return PoolFactoryAdminCap.fromBcs(fromB64(data.bcs.bcsBytes))
    }
    if (data.content) {
      return PoolFactoryAdminCap.fromSuiParsedData(data.content)
    }
    throw new Error(
  ...
  static async fetch(client: SuiClient, id: string): Promise<PoolFactoryAdminCap> {
    ...
    return PoolFactoryAdminCap.fromSuiObjectData(res.data)
  }
}
...
export function isPoolSimpleInfo(type: string): boolean {
  type = compressSuiType(type)
  return type === `${PKG_V1}::pool_factory::PoolSimpleInfo`
}
...
export class PoolSimpleInfo implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::pool_factory::PoolSimpleInfo`
  static readonly $numTypeParams = 0
  static readonly $isPhantom = [] as const

  readonly $typeName = PoolSimpleInfo.$typeName
  readonly $fullTypeName: `${typeof PKG_V1}::pool_factory::PoolSimpleInfo`
  readonly $typeArgs: []
  ...
  private constructor(typeArgs: [], fields: PoolSimpleInfoFields) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs
    ) as `${typeof PKG_V1}::pool_factory::PoolSimpleInfo`
    this.$typeArgs = typeArgs

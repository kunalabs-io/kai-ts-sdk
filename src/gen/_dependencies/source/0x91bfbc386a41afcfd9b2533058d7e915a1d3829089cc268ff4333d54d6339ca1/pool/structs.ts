...
export interface PoolFields<
  ...
  FeeType extends PhantomTypeArgument,
> {
  id: ToField<UID>
...
export type PoolReified<
  ...
  CoinTypeB extends PhantomTypeArgument,
  FeeType extends PhantomTypeArgument,
> = Reified<Pool<CoinTypeA, CoinTypeB, FeeType>, PoolFields<CoinTypeA, CoinTypeB, FeeType>>
...
> implements StructClass
{
  ...
  readonly $fullTypeName: `${typeof PKG_V1}::pool::Pool<${PhantomToTypeStr<CoinTypeA>}, ${PhantomToTypeStr<CoinTypeB>}, ${PhantomToTypeStr<FeeType>}>`
  readonly $typeArgs: [
    PhantomToTypeStr<CoinTypeA>,
    PhantomToTypeStr<CoinTypeB>,
    PhantomToTypeStr<FeeType>,
  ]
  ...
  private constructor(
    typeArgs: [PhantomToTypeStr<CoinTypeA>, PhantomToTypeStr<CoinTypeB>, PhantomToTypeStr<FeeType>],
    fields: PoolFields<CoinTypeA, CoinTypeB, FeeType>
  ) {
    this.$fullTypeName = composeSuiType(
      Pool.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::pool::Pool<${PhantomToTypeStr<CoinTypeA>}, ${PhantomToTypeStr<CoinTypeB>}, ${PhantomToTypeStr<FeeType>}>`
    this.$typeArgs = typeArgs
  ...
  static reified<
    ...
    FeeType extends PhantomReified<PhantomTypeArgument>,
  >(
    CoinTypeA: CoinTypeA,
    CoinTypeB: CoinTypeB,
    FeeType: FeeType
  ...
  > {
    return {
      ...
      ) as `${typeof PKG_V1}::pool::Pool<${PhantomToTypeStr<ToPhantomTypeArgument<CoinTypeA>>}, ${PhantomToTypeStr<ToPhantomTypeArgument<CoinTypeB>>}, ${PhantomToTypeStr<ToPhantomTypeArgument<FeeType>>}>`,
      typeArgs: [extractType(CoinTypeA), extractType(CoinTypeB), extractType(FeeType)] as [
        PhantomToTypeStr<ToPhantomTypeArgument<CoinTypeA>>,
        PhantomToTypeStr<ToPhantomTypeArgument<CoinTypeB>>,
        PhantomToTypeStr<ToPhantomTypeArgument<FeeType>>,
      ],
      isPhantom: Pool.$isPhantom,
      reifiedTypeArgs: [CoinTypeA, CoinTypeB, FeeType],
      fromFields: (fields: Record<string, any>) =>
        Pool.fromFields([CoinTypeA, CoinTypeB, FeeType], fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        Pool.fromFieldsWithTypes([CoinTypeA, CoinTypeB, FeeType], item),
      fromBcs: (data: Uint8Array) => Pool.fromBcs([CoinTypeA, CoinTypeB, FeeType], data),
      bcs: Pool.bcs,
      fromJSONField: (field: any) => Pool.fromJSONField([CoinTypeA, CoinTypeB, FeeType], field),
      fromJSON: (json: Record<string, any>) => Pool.fromJSON([CoinTypeA, CoinTypeB, FeeType], json),
      fromSuiParsedData: (content: SuiParsedData) =>
        Pool.fromSuiParsedData([CoinTypeA, CoinTypeB, FeeType], content),
      fromSuiObjectData: (content: SuiObjectData) =>
        Pool.fromSuiObjectData([CoinTypeA, CoinTypeB, FeeType], content),
      fetch: async (client: SuiClient, id: string) =>
        Pool.fetch(client, [CoinTypeA, CoinTypeB, FeeType], id),
      new: (
        fields: PoolFields<
          ToPhantomTypeArgument<CoinTypeA>,
          ToPhantomTypeArgument<CoinTypeB>,
  ...
  >(
    ...
    >
  > {
    return phantom(Pool.reified(CoinTypeA, CoinTypeB, FeeType))
  }
  static get p() {
    return Pool.phantom
  }
  ...
  static fromFields<
    ...
    FeeType extends PhantomReified<PhantomTypeArgument>,
  >(
    typeArgs: [CoinTypeA, CoinTypeB, FeeType],
...
export function isPoolRewardVault(type: string): boolean {
  type = compressSuiType(type)
  return type.startsWith(`${PKG_V1}::pool::PoolRewardVault` + '<')
}

export interface PoolRewardVaultFields<RewardCoin extends PhantomTypeArgument> {
  id: ToField<UID>
  coin: ToField<Balance<RewardCoin>>
}
...
export class PoolRewardVault<RewardCoin extends PhantomTypeArgument> implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::pool::PoolRewardVault`
  static readonly $numTypeParams = 1
  static readonly $isPhantom = [true] as const

  readonly $typeName = PoolRewardVault.$typeName
  readonly $fullTypeName: `${typeof PKG_V1}::pool::PoolRewardVault<${PhantomToTypeStr<RewardCoin>}>`
  readonly $typeArgs: [PhantomToTypeStr<RewardCoin>]
  readonly $isPhantom = PoolRewardVault.$isPhantom

  readonly id: ToField<UID>
  readonly coin: ToField<Balance<RewardCoin>>

  private constructor(
    typeArgs: [PhantomToTypeStr<RewardCoin>],
    fields: PoolRewardVaultFields<RewardCoin>
  ) {
    this.$fullTypeName = composeSuiType(
      PoolRewardVault.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::pool::PoolRewardVault<${PhantomToTypeStr<RewardCoin>}>`
    this.$typeArgs = typeArgs
  ...
  static reified<RewardCoin extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      ) as `${typeof PKG_V1}::pool::PoolRewardVault<${PhantomToTypeStr<ToPhantomTypeArgument<RewardCoin>>}>`,
      typeArgs: [extractType(RewardCoin)] as [PhantomToTypeStr<ToPhantomTypeArgument<RewardCoin>>],
      isPhantom: PoolRewardVault.$isPhantom,
      reifiedTypeArgs: [RewardCoin],
      fromFields: (fields: Record<string, any>) => PoolRewardVault.fromFields(RewardCoin, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        PoolRewardVault.fromFieldsWithTypes(RewardCoin, item),
      fromBcs: (data: Uint8Array) => PoolRewardVault.fromBcs(RewardCoin, data),
      bcs: PoolRewardVault.bcs,
      fromJSONField: (field: any) => PoolRewardVault.fromJSONField(RewardCoin, field),
      fromJSON: (json: Record<string, any>) => PoolRewardVault.fromJSON(RewardCoin, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        PoolRewardVault.fromSuiParsedData(RewardCoin, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        PoolRewardVault.fromSuiObjectData(RewardCoin, content),
      fetch: async (client: SuiClient, id: string) => PoolRewardVault.fetch(client, RewardCoin, id),
      new: (fields: PoolRewardVaultFields<ToPhantomTypeArgument<RewardCoin>>) => {
        return new PoolRewardVault([extractType(RewardCoin)], fields)
      },
      kind: 'StructClassReified',
    }
  }
  ...
  static phantom<RewardCoin extends PhantomReified<PhantomTypeArgument>>(
    ...
    return phantom(PoolRewardVault.reified(RewardCoin))
  }
  static get p() {
  ...
  static fromSuiObjectData<RewardCoin extends PhantomReified<PhantomTypeArgument>>(
    typeArg: RewardCoin,
    data: SuiObjectData
  ): PoolRewardVault<ToPhantomTypeArgument<RewardCoin>> {
    if (data.bcs) {
      if (data.bcs.dataType !== 'moveObject' || !isPoolRewardVault(data.bcs.type)) {
        throw new Error(`object at is not a PoolRewardVault object`)
      }
      ...
      return PoolRewardVault.fromBcs(typeArg, fromB64(data.bcs.bcsBytes))
    }
    if (data.content) {
      return PoolRewardVault.fromSuiParsedData(typeArg, data.content)
    }
    throw new Error(
      'Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.'
    )

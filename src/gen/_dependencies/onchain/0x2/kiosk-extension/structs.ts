...
export function isExtension(type: string): boolean {
  ...
  return type === `${PKG_V30}::kiosk_extension::Extension`
}
...
export class Extension implements StructClass {
  ...
  static readonly $typeName = `${PKG_V30}::kiosk_extension::Extension`
  static readonly $numTypeParams = 0
  static readonly $isPhantom = [] as const

  readonly $typeName = Extension.$typeName
  readonly $fullTypeName: `${typeof PKG_V30}::kiosk_extension::Extension`
  readonly $typeArgs: []
...
export function isExtensionKey(type: string): boolean {
  type = compressSuiType(type)
  return type.startsWith(`${PKG_V30}::kiosk_extension::ExtensionKey` + '<')
}
...
export class ExtensionKey<T0 extends PhantomTypeArgument> implements StructClass {
  ...
  static readonly $typeName = `${PKG_V30}::kiosk_extension::ExtensionKey`
  static readonly $numTypeParams = 1
  static readonly $isPhantom = [true] as const

  readonly $typeName = ExtensionKey.$typeName
  readonly $fullTypeName: `${typeof PKG_V30}::kiosk_extension::ExtensionKey<${PhantomToTypeStr<T0>}>`
  ...
  private constructor(typeArgs: [PhantomToTypeStr<T0>], fields: ExtensionKeyFields<T0>) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs
    ) as `${typeof PKG_V30}::kiosk_extension::ExtensionKey<${PhantomToTypeStr<T0>}>`
    this.$typeArgs = typeArgs
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        ExtensionKey.$typeName,
        ...[extractType(T0)]
      ) as `${typeof PKG_V30}::kiosk_extension::ExtensionKey<${PhantomToTypeStr<ToPhantomTypeArgument<T0>>}>`,

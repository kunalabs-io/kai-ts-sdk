...
export class Token<T0 extends PhantomTypeArgument> implements StructClass {
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fromBcs: (data: Uint8Array) => Token.fromFields(T0, reifiedBcs.parse(data)),
      bcs: reifiedBcs,
...
export class TokenPolicyCap<T0 extends PhantomTypeArgument> implements StructClass {
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fromBcs: (data: Uint8Array) => TokenPolicyCap.fromFields(T0, reifiedBcs.parse(data)),
      bcs: reifiedBcs,
...
export class TokenPolicy<T0 extends PhantomTypeArgument> implements StructClass {
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fromBcs: (data: Uint8Array) => TokenPolicy.fromFields(T0, reifiedBcs.parse(data)),
      bcs: reifiedBcs,
...
export class ActionRequest<T0 extends PhantomTypeArgument> implements StructClass {
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fromBcs: (data: Uint8Array) => ActionRequest.fromFields(T0, reifiedBcs.parse(data)),
      bcs: reifiedBcs,
...
export class TokenPolicyCreated<T0 extends PhantomTypeArgument> implements StructClass {
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fromBcs: (data: Uint8Array) => TokenPolicyCreated.fromFields(T0, reifiedBcs.parse(data)),
      bcs: reifiedBcs,

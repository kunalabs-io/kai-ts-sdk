...
export class Bag implements StructClass {
  ...
  static readonly $typeName = `${PKG_V31}::bag::Bag`
  ...
  private constructor(typeArgs: [], fields: BagFields) {
    this.$fullTypeName = composeSuiType(Bag.$typeName, ...typeArgs) as `${typeof PKG_V31}::bag::Bag`
  ...
  static reified(): BagReified {
    return {
      ...
      fullTypeName: composeSuiType(Bag.$typeName, ...[]) as `${typeof PKG_V31}::bag::Bag`,
      typeArgs: [] as [],

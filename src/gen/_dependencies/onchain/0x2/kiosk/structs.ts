...
export class Kiosk implements StructClass {
  ...
  static reified(): KioskReified {
    ...
    return {
      ...
      fromBcs: (data: Uint8Array) => Kiosk.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
...
export class KioskOwnerCap implements StructClass {
  ...
  static reified(): KioskOwnerCapReified {
    ...
    return {
      ...
      fromBcs: (data: Uint8Array) => KioskOwnerCap.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
  ...
  static get bcs() {
    ...
    return KioskOwnerCap.cachedBcs
  }
...
export class PurchaseCap<T0 extends PhantomTypeArgument> implements StructClass {
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fromBcs: (data: Uint8Array) => PurchaseCap.fromFields(T0, reifiedBcs.parse(data)),
      bcs: reifiedBcs,
...
export class Listing implements StructClass {
  ...
  static reified(): ListingReified {
    ...
    return {
      ...
      fromBcs: (data: Uint8Array) => Listing.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
...
export class Lock implements StructClass {
  ...
  static reified(): LockReified {
    ...
    return {
      ...
      fromBcs: (data: Uint8Array) => Lock.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
...
export class ItemListed<T0 extends PhantomTypeArgument> implements StructClass {
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fromBcs: (data: Uint8Array) => ItemListed.fromFields(T0, reifiedBcs.parse(data)),
      bcs: reifiedBcs,
...
export class ItemPurchased<T0 extends PhantomTypeArgument> implements StructClass {
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fromBcs: (data: Uint8Array) => ItemPurchased.fromFields(T0, reifiedBcs.parse(data)),
      bcs: reifiedBcs,
  ...
  static get bcs() {
    ...
    return ItemPurchased.cachedBcs
  }
...
export class ItemDelisted<T0 extends PhantomTypeArgument> implements StructClass {
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fromBcs: (data: Uint8Array) => ItemDelisted.fromFields(T0, reifiedBcs.parse(data)),
      bcs: reifiedBcs,

...
export function isVersionChangeCap(type: string): boolean {
  ...
  return type === `${PKG_V30}::versioned::VersionChangeCap`
}
...
export class VersionChangeCap implements StructClass {
  ...
  static readonly $typeName = `${PKG_V30}::versioned::VersionChangeCap`
  static readonly $numTypeParams = 0
  static readonly $isPhantom = [] as const

  readonly $typeName = VersionChangeCap.$typeName
  readonly $fullTypeName: `${typeof PKG_V30}::versioned::VersionChangeCap`
  readonly $typeArgs: []
...
export function isVersioned(type: string): boolean {
  type = compressSuiType(type)
  return type === `${PKG_V30}::versioned::Versioned`
}
...
export class Versioned implements StructClass {
  ...
  static readonly $typeName = `${PKG_V30}::versioned::Versioned`
  static readonly $numTypeParams = 0
  static readonly $isPhantom = [] as const

  readonly $typeName = Versioned.$typeName
  readonly $fullTypeName: `${typeof PKG_V30}::versioned::Versioned`
  readonly $typeArgs: []

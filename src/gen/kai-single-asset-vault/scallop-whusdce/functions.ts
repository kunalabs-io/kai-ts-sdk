...
export function assertScallopPool(tx: Transaction, pool: TransactionObjectInput) {
  return tx.moveCall({
    target: `${PUBLISHED_AT}::scallop_whusdce::assert_scallop_pool`,
...
export function new_(tx: Transaction, args: NewArgs) {
  return tx.moveCall({
    target: `${PUBLISHED_AT}::scallop_whusdce::new`,
...
export function assertVersion(tx: Transaction, strategy: TransactionObjectInput) {
  return tx.moveCall({
    target: `${PUBLISHED_AT}::scallop_whusdce::assert_version`,
...
export function assertAdmin(tx: Transaction, args: AssertAdminArgs) {
  return tx.moveCall({
    target: `${PUBLISHED_AT}::scallop_whusdce::assert_admin`,
...
export function joinVault(tx: Transaction, args: JoinVaultArgs) {
  return tx.moveCall({
    target: `${PUBLISHED_AT}::scallop_whusdce::join_vault`,
    arguments: [
...
export function assertScallopMarket(tx: Transaction, market: TransactionObjectInput) {
  return tx.moveCall({
    target: `${PUBLISHED_AT}::scallop_whusdce::assert_scallop_market`,
...
export function assertScallopRewardsPool(tx: Transaction, pool: TransactionObjectInput) {
  return tx.moveCall({
    target: `${PUBLISHED_AT}::scallop_whusdce::assert_scallop_rewards_pool`,
    arguments: [obj(tx, pool)],
  })
}
...
export function removeFromVault(tx: Transaction, args: RemoveFromVaultArgs) {
  return tx.moveCall({
    target: `${PUBLISHED_AT}::scallop_whusdce::remove_from_vault`,
    arguments: [
      obj(tx, args.cap),
      obj(tx, args.strategy),
...
export function migrate(tx: Transaction, args: MigrateArgs) {
  return tx.moveCall({
    target: `${PUBLISHED_AT}::scallop_whusdce::migrate`,
    arguments: [obj(tx, args.cap), obj(tx, args.strategy)],
  })
}
...
export function rebalance(tx: Transaction, args: RebalanceArgs) {
  return tx.moveCall({
    target: `${PUBLISHED_AT}::scallop_whusdce::rebalance`,
    arguments: [
      obj(tx, args.cap),
      obj(tx, args.strategy),
      obj(tx, args.vault),
...
export function takeProfitsForSelling(tx: Transaction, args: TakeProfitsForSellingArgs) {
  return tx.moveCall({
    target: `${PUBLISHED_AT}::scallop_whusdce::take_profits_for_selling`,
    arguments: [
      obj(tx, args.cap),
      obj(tx, args.strategy),
...
export function skimBaseProfits(tx: Transaction, args: SkimBaseProfitsArgs) {
  return tx.moveCall({
    target: `${PUBLISHED_AT}::scallop_whusdce::skim_base_profits`,
    arguments: [
      obj(tx, args.cap),
      obj(tx, args.strategy),
      obj(tx, args.scallopVersion),
...
export function depositSoldProfits(tx: Transaction, args: DepositSoldProfitsArgs) {
  return tx.moveCall({
    target: `${PUBLISHED_AT}::scallop_whusdce::deposit_sold_profits`,
    arguments: [
      obj(tx, args.cap),
      obj(tx, args.strategy),
      obj(tx, args.vault),
...
export function withdraw(tx: Transaction, args: WithdrawArgs) {
  return tx.moveCall({
    target: `${PUBLISHED_AT}::scallop_whusdce::withdraw`,
    arguments: [
      obj(tx, args.strategy),
      obj(tx, args.ticket),
      obj(tx, args.scallopVersion),

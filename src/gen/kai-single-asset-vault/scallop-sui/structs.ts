...
export function isAdminCap(type: string): boolean {
  ...
  return type === `${PKG_V4}::scallop_sui::AdminCap`
}
...
export class AdminCap implements StructClass {
  ...
  static readonly $typeName = `${PKG_V4}::scallop_sui::AdminCap`
  static readonly $numTypeParams = 0
  static readonly $isPhantom = [] as const

  readonly $typeName = AdminCap.$typeName
  readonly $fullTypeName: `${typeof PKG_V4}::scallop_sui::AdminCap`
  readonly $typeArgs: []
  ...
  private constructor(typeArgs: [], fields: AdminCapFields) {
    this.$fullTypeName = composeSuiType(
      AdminCap.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V4}::scallop_sui::AdminCap`
...
export function isStrategy(type: string): boolean {
  type = compressSuiType(type)
  return type === `${PKG_V4}::scallop_sui::Strategy`
}
...
export class Strategy implements StructClass {
  ...
  static readonly $typeName = `${PKG_V4}::scallop_sui::Strategy`
  static readonly $numTypeParams = 0
  static readonly $isPhantom = [] as const

  readonly $typeName = Strategy.$typeName
  readonly $fullTypeName: `${typeof PKG_V4}::scallop_sui::Strategy`
  readonly $typeArgs: []
  ...
  private constructor(typeArgs: [], fields: StrategyFields) {
    this.$fullTypeName = composeSuiType(
      Strategy.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V4}::scallop_sui::Strategy`
    this.$typeArgs = typeArgs

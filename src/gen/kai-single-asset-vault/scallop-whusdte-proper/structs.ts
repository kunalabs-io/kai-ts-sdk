...
export function isAdminCap(type: string): boolean {
  ...
  return type === `${PKG_V5}::scallop_whusdte_proper::AdminCap`
}
...
export class AdminCap implements StructClass {
  ...
  static readonly $typeName = `${PKG_V5}::scallop_whusdte_proper::AdminCap`
  static readonly $numTypeParams = 0
  static readonly $isPhantom = [] as const

  readonly $typeName = AdminCap.$typeName
  readonly $fullTypeName: `${typeof PKG_V5}::scallop_whusdte_proper::AdminCap`
  readonly $typeArgs: []
  ...
  private constructor(typeArgs: [], fields: AdminCapFields) {
    this.$fullTypeName = composeSuiType(
      AdminCap.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V5}::scallop_whusdte_proper::AdminCap`
...
export function isStrategy(type: string): boolean {
  type = compressSuiType(type)
  return type === `${PKG_V5}::scallop_whusdte_proper::Strategy`
}
...
export class Strategy implements StructClass {
  ...
  static readonly $typeName = `${PKG_V5}::scallop_whusdte_proper::Strategy`
  static readonly $numTypeParams = 0
  static readonly $isPhantom = [] as const

  readonly $typeName = Strategy.$typeName
  readonly $fullTypeName: `${typeof PKG_V5}::scallop_whusdte_proper::Strategy`
  readonly $typeArgs: []
  ...
  private constructor(typeArgs: [], fields: StrategyFields) {
    this.$fullTypeName = composeSuiType(
      Strategy.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V5}::scallop_whusdte_proper::Strategy`
    this.$typeArgs = typeArgs

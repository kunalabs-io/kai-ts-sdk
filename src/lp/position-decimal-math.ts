...
export interface PositionDecimalMathConstructorArg {
  pa: Decimal
  pb: Decimal
  L: Decimal
  CX: Decimal
...
export interface PositionDecimalMathForNewPositionArgs {
  tickA: number
  tickB: number
  P0: Decimal
  UX: Decimal
...
export class PositionDecimalMath {
  pa: Decimal
  pb: Decimal
  L: Decimal
  CX: Decimal
  ...
  constructor(args: PositionDecimalMathConstructorArg) {
  ...
  static forNewPosition(args: PositionDecimalMathForNewPositionArgs) {
    ...
    const X = PositionDecimalMath.X(pa, pb, args.P0, args.L)
    const Y = PositionDecimalMath.Y(pa, pb, args.P0, args.L)
  ...
  static fromPositionModel(args: PositionModel) {
    ...
    return new PositionDecimalMath({
      pa,
      pb,
      L: new Decimal(args.l.toString()),
      CX: new Decimal(args.cx.toString()),
      CY: new Decimal(args.cy.toString()),
      DX: new Decimal(args.dx.toString()),
      DY: new Decimal(args.dy.toString()),
    })
  }
  ...
  Y(p: Decimal): Decimal {
    return PositionDecimalMath.Y(this.pa, this.pb, p, this.L)
  }
